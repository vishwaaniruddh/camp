				...
				<div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul class="sidebar-vertical">
							...
							<li class="submenu">
								<a href="javascript:void(0);"><i class="fa fa-list"></i> <span> Super Admin</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li class="submenu">
										<a href="javascript:void(0);"> <i class="fe fe-user"></i> <span>User Management</span> <span class="menu-arrow"></span></a>
										<ul style="display: none;" class="level2">
											<li>
												<a href="users.php"> <span>Users</span></a>
											</li>
											<li>
												<a href="roles-permission.php"><span>Roles & Permission</span></a>
											</li>
											<li>
							...
							<li>
								<!-- debit-notes.php -->
								<a href="#"><i class="fe fe-file-text"></i> <span>Debit Notes(Coming Soon)</span></a>
							</li>
							<!-- /Purchases -->
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-box"></i><span>Reports (Coming Soon)</span> <span class="menu-arrow"></span></a>
								<ul>
									...
									<li><a href="#">Low Stock Report</a></li>
