...
<div class="sidebar" id="sidebar">
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			<ul class="sidebar-vertical">
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						<li><a href="user_ui.php"><i class="fe fe-user"></i> Users</a></li>
						...
						<li class="submenu">
							<a href="javascript:void(0);"><i class="fa fa-list"></i> <span>Location</span> <span
									class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="zones.php"><i class="fe fe-truck"></i> Zones</a></li>
								<li><a href="branchs.php"><i class="fe fe-truck"></i> Branches</a></li>
								<li><a href="states.php"><i class="fe fe-truck"></i> States</a></li>
			...
			<li><a href="customer-purchase-order.php"><i class="fe fe-list"></i> <span>Customer Purchase
						Orders</span></a></li>
