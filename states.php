		...
		<div class="content-page-header ">
			...
			<div class="list-btn">
				...
				<li class="">
					...
					<li>
						<a class="btn btn-primary" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_state"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add state</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="modal-content">
			...
			<form id="addstateForm">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary paid-continue-btn">Add state</button>
				</div>
			</form>
		</div>
	</div>
									...
									<div class="row">
										...
										<div class="col-lg-12 col-sm-12">
											<div class="input-block mb-3">
												...
												<select class="form-select" name="state_status" id="state_status">
...
<?php
$names = $conn->query("SELECT DISTINCT name FROM camp_states")->fetch_all(MYSQLI_ASSOC);
$statuses = $conn->query("SELECT DISTINCT status FROM camp_states")->fetch_all(MYSQLI_ASSOC);
?>
...
<script src="./assets/js/helper/state.js"></script>
