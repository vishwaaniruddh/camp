		...
		<div class="content-page-header ">
			...
			<div class="list-btn">
				...
				<li class="">
					...
					<li>
						<a class="btn btn-primary" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_zone"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add zone</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="modal custom-modal fade" id="add_zone" role="dialog">
		...
		<div class="modal-content">
			...
			<form id="addzoneForm">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary paid-continue-btn">Add zone</button>
				</div>
			</form>
		</div>
	</div>
...
<!-- Edit zone Modal -->
<div class="modal custom-modal fade" id="edit_zone" role="dialog">
	<div class="modal-dialog modal-dialog-centered modal-md">
		<div class="modal-content">
			<div class="modal-header border-0 pb-0">
				<div class="form-header modal-header-title text-start mb-0">
									...
									<div class="row">
										...
										<div class="col-lg-12 col-sm-12">
											<div class="input-block mb-3">
												...
												<select class="form-select" name="zone_status" id="zone_status">
...
<?php
$names = $conn->query("SELECT DISTINCT name FROM camp_zones")->fetch_all(MYSQLI_ASSOC);
$statuses = $conn->query("SELECT DISTINCT status FROM camp_zones")->fetch_all(MYSQLI_ASSOC);
?>
...
<script src="./assets/js/helper/zone.js"></script>
